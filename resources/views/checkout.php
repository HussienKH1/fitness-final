...
<body>
    ...
    <div class="Pcontainer">
        <div class="Paymentform">
            ...
            <div class="left">
                    ...
                    <input type="text" id="card-holder-name" name="name" placeholder="Enter your name" >

                    <label for="email">Email</label>
                    <input type="text" id="email" name="email" placeholder="Enter email" >

                    <label for="line1">Street Address</label> 
                    <input type="text" id="line1" name="line1" placeholder="Enter address">
                    ...
                    <div class="zip">
                        ...
                        <label class="postal">
                            Zip code
                            <input id="postal_code" name="postal_code" type="number" placeholder="Zip code">
                        </label>
                </div>  
        </div>
            <div class="right">
                <div class="payment">
                    ...
                    <img src="Images/PayPal Here Payments Acceptance Logo.png" width="300px">
                    <br>

                    <label for="">Credit Information</label>

                    <div id="card-element" class="elements"></div>
                    <div id="card-errors" class="space-y-2 text-red-500"></div>
                    <button id="card-button"  data-secret="{{$intent -> client_secret}}" class="btn">Pay Now</button>
                </div>
            </div>
    </form>
    ...
    <script>
        ...
        const cardButtong = document.getElementById('card-button');
